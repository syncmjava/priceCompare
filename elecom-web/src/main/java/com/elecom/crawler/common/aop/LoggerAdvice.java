package com.elecom.crawler.common.aop;
...
public class LoggerAdvice {
     ...
     */
    @Before("within(com.rakuten.inv.controller..*)")
     ...
     */
    @After("within(com.rakuten.inv.controller..*)")
     ...
     * @param ex
     */
    @AfterThrowing(pointcut = "within(com.rakuten.inv.controller..*)", throwing = "ex")
